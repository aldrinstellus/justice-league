...
export function Tabs({ children, className, defaultValue, value: controlledValue, onValueChange }: TabsProps) {
...
export function TabsContent({ children, className, value }: TabsContentProps) {
  ...
  return (
    <div className={cn('mt-2 ring-offset-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-zinc-400 focus-visible:ring-offset-2', className)}>
      {children}
    </div>
  );
}
